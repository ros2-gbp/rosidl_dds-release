...
%global pkg_name rosidl_generator_dds_idl
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rosidl-generator-dds-idl
Version:        0.13.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Shane Loretz <sloretz@openrobotics.org> - 0.13.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Shane Loretz <sloretz@openrobotics.org> - 0.13.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Shane Loretz <sloretz@openrobotics.org> - 0.13.0-1
- Autogenerated by Bloom
